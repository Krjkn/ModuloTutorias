...
if (!isset($_POST['rnueva'])) {
?>
<form name="contrasena" method="post" action="cambia_contrasenades.php">
	<table align="center">
		<tr>
			<th> Usuario: </th>
			<td>
				<input name="usuario" type="text" value="<?php echo $user ?>" size="30" maxlength="50" readonly="true"/>
			</td>
		</tr>
		<tr>
