...
<body>
<div id="mainFrame">
<h3 align="center"> Eliminacion de Grupos de Tutorias que no tiene alumnos inscritos</h3> 
...
<form method="get" action="eliminagrupo.php">
	<table align="center">
    	<tr>
...
where  g.alumnos_inscritos = 0 and g.materia=m.materia and mc.carrera = c.carrera and mc.reticula = c.reticula and mc.materia = m.materia and
p.rfc = g.rfc and g.periodo= '$periodo' ";
	...
	while ($fila = $res_grupos->fetch_assoc()) 
	{
		...
		$tabla_grupos_docente .= "<img src='img/elimina.gif' onclick='abrir_documento(\"eliminagrupobd.php\", \" \", \"".$periodo."\", \"".trim($materia)."\", \"".trim($grupo)."\", \"enviar_lista\")' alt='Lista de Asistencia' style='cursor:pointer'/>";
