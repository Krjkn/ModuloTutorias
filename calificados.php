...
and s.materia = g.materia and s.periodo = g.periodo and s.grupo = g.grupo ";
	...
	?>	<form action="calificabd.php" method="get" name="form1">	<?php 	echo $tabla_grupos_docente; 	?>	<input name="periodo" type="hidden"  value="<?php echo $periodo; ?>"/>	<input name="i" type="hidden"  value="<?php echo $i; ?>"/>	<input name="usuario" type="hidden"  value="<?php echo $usuario; ?>"/>	<br />	<center><H2>EXCELENTE = 4 / NOTABLE = 3 / BUENO = 2 / SUFICIENTE = 1 / NO APROBADO = 0</H2>	<center><input type="submit" value="Actualiza y Continua" name="busca" class="boton" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="regresar" value="Cancelar" class="boton" onClick="javascript:window.location = 'pasa.php?usuario=<?php echo $usuario; ?>'&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="regresar" value="Cancelar" class="boton" onClick="javascript:window.location = 'pasa.php?usuario=<?php echo $usuario; ?>'" /></center>	</form>
