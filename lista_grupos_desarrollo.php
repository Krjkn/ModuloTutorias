...
function abrir_documentof(pagina, vtipo, vperiodo, vmateria, vgrupo)
{
	formulario = document.enviar_doctof;
	...
	formulario.grupo.value = vgrupo;
	formulario.submit();
}function abrir_documentoff(pagina, vtipo, vperiodo, vmateria, vgrupo){	formulario = document.enviar_doctoff;	formulario.target="_blank";	formulario.action = pagina;	formulario.tipo.value = vtipo;	formulario.periodo.value = vperiodo;	formulario.materia.value = vmateria;	formulario.usuario.value = vgrupo;	formulario.submit();}
</script>
<body>
<div id="mainFrame">
...
<form name="enviar_doctof" method="get" target="_blank">
	...
	<input name="materia" type="hidden" />
	<input name="grupo" type="hidden" />
</form><form name="enviar_doctoff" method="get" target="_blank">	<input name="tipo" type="hidden" />	<input name="periodo" type="hidden" />	<input name="materia" type="hidden" />	<input name="usuario" type="hidden" /></form>
<form method="get" action="lista_grupos_desarrollo.php">
	<table align="center">
    	<tr>
...
p.rfc = g.rfc and g.periodo= '$periodo' ";
	...
	$tabla_grupos_docente .= "		<th> ReporteF </th>";
	$tabla_grupos_docente .= "		<th> Diagnostico </th>";
	$tabla_grupos_docente .= "		<th> Alumno Evaluo </th>";
	...
	while ($fila = $res_grupos->fetch_assoc()) 
	{
		...
		$tabla_grupos_docente .= "<img src='img/imprime.gif' width=32 height=32  onclick='abrir_documentof(\"lista_extra_grupo.pdf.php\", \" \", \"".$periodo."\", \"".trim($materia)."\", \"".trim($grupo)."\", \"enviar_lista\")' alt='Lista de Asistencia' style='cursor:pointer'/>";
		$tabla_grupos_docente .= "<img src='img/listado.png' width=32 height=32  onclick='abrir_documento(\"lista_extra_detalle2.php  \", \" \", \"".$periodo."\", \"".trim($rfc)."\", \"".trim($grupo)."\", \"enviar_lista\")' alt='Lista de Asistencia' style='cursor:pointer'/>";
		$tabla_grupos_docente .= "</td>";
		$tabla_grupos_docente .= "<td align='center'>"; 
		$tabla_grupos_docente .= "<img src='img/imprime.gif' width=32 height=32  onclick='abrir_documentoff(\"reporte1.php\", \" \", \"".$periodo."\", \"".trim($rfc)."\", \"".trim($rfc)."\", \"enviar_lista\")' alt='Lista de Asistencia' style='cursor:pointer'/>";
		$tabla_grupos_docente .= "</td>";
		$tabla_grupos_docente .= "<td align='center'>"; 
		$tabla_grupos_docente .= "<img src='img/imprime.gif' width=32 height=32  onclick='abrir_documentoff(\"reporte2.php\", \" \", \"".$periodo."\", \"".trim($rfc)."\", \"".trim($rfc)."\", \"enviar_lista\")' alt='Lista de Asistencia' style='cursor:pointer'/>";
		$tabla_grupos_docente .= "</td>";
		$tabla_grupos_docente .= "<td align='center'>"; 
		$tabla_grupos_docente .= "<img src='img/imprime.gif' width=32 height=32  onclick='abrir_documentoff(\"reportefin.php\", \" \", \"".$periodo."\", \"".trim($rfc)."\", \"".trim($rfc)."\", \"enviar_lista\")' alt='Lista de Asistencia' style='cursor:pointer'/>";
		$tabla_grupos_docente .= "</td>";
		$tabla_grupos_docente .= "<td align='center'>"; 
		$tabla_grupos_docente .= "<img src='img/imprime.gif' width=32 height=32  onclick='abrir_documentoff(\"diagnostico.php\", \" \", \"".$periodo."\", \"".trim($rfc)."\", \"".trim($rfc)."\", \"enviar_lista\")' alt='Lista de Asistencia' style='cursor:pointer'/>";
		$tabla_grupos_docente .= "</td>";
		$tabla_grupos_docente .= "<td align='center'>"; 
		$tabla_grupos_docente .= "<img src='img/lista.gif' width=32 height=32  onclick='abrir_documento(\"evaluaciondes.php\", \" \", \"".$periodo."\", \"".trim($rfc)."\", \"".trim($grupo)."\", \"enviar_lista\")' alt='Lista de Asistencia' style='cursor:pointer'/>";
		$tabla_grupos_docente .= "</td>";
		$tabla_grupos_docente .= "</tr>";
		$non = ($non)?false:true;
	}	
